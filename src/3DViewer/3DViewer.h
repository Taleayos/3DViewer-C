...
/**
 * @brief Структура, хранящая указатель на структуру координат, минимальные и максимальные значения по осям X, Y, Z
...
/**
 * @brief Главная структура, объединяющая в себе все координаты, полигоны и их количество
...
/**
 * @brief Функция для определения количества вершин и полигонов в объектном файле
 * @param file_name название объектного файла
...
/**
 * @brief Функция для нахождения MAX среди разности (MAX - MIN) всех координат, необходима для нахождения коэфициента масштабирования 
 * @param figure указатель на структуру модели
*/
